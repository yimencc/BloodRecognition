...
class CAB(nn.Module):
    ...
    def __init__(self, in_features):
        ...
        self.fc1 = nn.Conv2d(in_features, in_features // 4, (1, 1), bias=False)  # (b, C, 1) -> (b, C/4, 1)
        self.relu = nn.ReLU()
        self.fc2 = nn.Conv2d(in_features // 4, in_features, (1, 1), bias=False)  # (b, C/4, 1) -> (b, C, 1)
...
class SAB(nn.Module):
    ...
    def __init__(self, kernel_size=3):
        ...
        self.conv1 = nn.Conv2d(2, 1, (kernel_size, kernel_size), padding=(padding, padding), bias=False)
        self.sigmoid = nn.Sigmoid()
